    ...
    ImportDeclaration(node) {
      ...
      if (isModule) {
        context.report({
          node,
          message:
            "Do not import another module's internal files or functionality.",
        });
      }
    },
  };
...
const meta = {
  ...
  docs: {
    description:
      'You should not access another "unit"\'s internal files or functions.',
